...
![mancala1](images/mancala_epsilon_01_fixed.png)
![mancala2](images/mancala_epsilon_1_fixed.png)
...
![mancala3](images/mancala_epsilon_2.png)
...
##### Grid World:
![gid_world](images/path_finding_environment.png)

##### Optimal Path:
![Optimal path](images/path_finding_route.png)

Intially, the RL agenet was able to find the most optimal path in a simple 2x3 grid with one obstacle very quickly with less than 10 rounds. As I scaled up the grid environment and increase the complexity of the obstacle, I have encountered the following problem:
...
#####  Runtime(seconds) per Round
![path_runtime](images/path_finding_runtime.png)
##### Total Number of Explored States per Round
![path_states](images/path_finding_states_num.png)
